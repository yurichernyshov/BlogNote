"""
Django settings for BlogNote project.
...
# SECRET_KEY = 'dm_879u$j(&8&-fqg@ojz$=ta4c@qqat((co(pq2(m*95fnx1u'
...
ALLOWED_HOSTS = [u'https://lit-fortress-67024.herokuapp.com','127.0.0.1']
# For example: 
